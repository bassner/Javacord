...
/**
 * Either a user or a member; contains methods that should be callable on both.
 */
public interface UserLike extends DiscordEntity, Messageable, Nameable, Mentionable, Permissionable {
    @Override
