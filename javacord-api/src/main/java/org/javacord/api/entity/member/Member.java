...
public interface Member extends UserLike, MemberAttachableListenerManager {
    ...
    default CompletableFuture<Void> ban() {
        return getServer().banUser(getId(), 0, null);
    }
     ...
     * @return A future to check if the ban was successful.
     */
    default CompletableFuture<Void> ban(int deleteMessageDays) {
        return getServer().banUser(getId(), deleteMessageDays, null);
    }
     ...
     * @return A future to check if the ban was successful.
     */
    default CompletableFuture<Void> ban(int deleteMessageDays, String reason) {
