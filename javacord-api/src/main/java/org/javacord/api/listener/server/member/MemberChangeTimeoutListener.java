 ...
 */
@FunctionalInterface
public interface MemberChangeTimeoutListener extends MemberAttachableListener, ServerAttachableListener,
     ...
     */
    void onMemberChangeTimeout(MemberChangeTimeoutEvent event);
}
